...
const collections: IconifyJSON[] = [
  ...
  },
  {
    ...
    aliases: { 'curly-braces': { parent: 'braces' } },
    width: 24,
    height: 24,
  },
  {
  ...
  },
  {
    ...
    not_found: ['dashboard'],
    aliases: {
      'do-not-disturb-alt': { parent: 'cancel' },
      'encryption-expiration': { parent: 'lock-clock' },
      'feature-highlight': { parent: 'star-circle-outline' },
      'lightbulb-error-outline': { parent: 'lightbulb-alert-outline' },
      offline: { parent: 'cloud-off-outline' },
    },
    width: 24,
    height: 24,
  },
